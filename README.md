...
<img width="2063" height="1321" alt="image" src="https://github.com/user-attachments/assets/3a380078-3134-4921-8697-bffca564cb3c" />


**PCB Art Simulator** 是一个专业的 Web 工具，旨在帮助 PCB 艺术家和电子工程师将普通图像转换为 PCB 制造所需的工业级分层视图。

它使用先进的颜色映射算法，将输入图像的颜色智能分配给 PCB 的物理结构层（基材、阻焊、线路、焊盘、丝印），并提供强大的交互式编辑功能。它使用先进的颜色映射算法，将输入图像的颜色智能分配给 PCB 的物理结构层（基材、阻焊、线路、焊盘、丝印），并提供强大的交互式编辑功能。
...
> 使用**https://liuxd-1230.github.io/PICtoPCB/** 快速开始
